            ...
            {MODES.map((m) => (
              <button
                ...
                className={cn(
                  ...
                  mode === m.id
                    ? "border-kore-accent/60 bg-kore-accent/10 text-kore-accent shadow-glow"
                    : "border-kore-border bg-kore-bg/60 text-kore-muted hover:border-kore-accent/30 hover:text-white"
                )}
              >
